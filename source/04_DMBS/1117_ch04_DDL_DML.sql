...
DELETE FROM DEPT; -- 불가(EMP테이블의 참조된 데이터가 있어서)
  ...
  FOREIGN KEY(DEPTNO) REFERENCES DEPT01(DEPTNO)
   ...
   SELECT * FROM DEPT WHERE DEPTNO>10
    ...
    INSERT INTO MY_DATA VALUES (5, 'Good','ggoood', 44450.00);
    ...
    SELECT * FROM EMP;
    SELECT * FROM EMP01;
    INSERT INTO EMP01 VALUES (1001, '홍길동','CLERK', SYSDATE, 9999, 10);
    INSERT INTO EMP01 VALUES (1002, '홍길동', SYSDATE, 9999, 10);
    INSERT INTO EMP01 VALUES (1003, '홍길동', SYSDATE, 9999, 10);
    INSERT INTO EMP01 VALUES (1004, '홍길동', SYSDATE, 9999, 10);
    ...
    UPDATE EMP01 SET SAL = SAL + 1000 WHERE SAL;
...
-- (2) FORIEGN KEY : 테이블의 열이 다른 테이블의 열을 참조
-- (3) NOT NUL     : NULL을 포함하지 않는다
...
INSERT INTO DEPT1 VALUES (50, 'SALES', '서울');

INSERT INTO EMP1 (EMPNO,ENAME,JOB, DEPTNO) VALUES (9001, 'HONG','MANAGER',40);
-- INSERT에서 언급되지 않은 필드는 DEFUALT값이나 NULL값으로 입력.
...
CREATE TABLE STUDENT(
    ...
    INSERT INTO MAJOR VALUES (101, '홍길동',99,'1');
    INSERT INTO MAJOR VALUES (102, '신길동',100,'2');
