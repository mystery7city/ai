...
아래 [참고 문서]에는 여러 종류의 정보가 포함될 수 있습니다.

[SECTION 0: 사용자 계약서 OCR (있을 경우)]
- 사용자가 업로드한 계약서 또는 안내문을 OCR로 추출한 원문입니다.
- 이는 본 사건의 '사실관계'에 해당하며, 존재하는 경우 반드시 최우선으로 확인해야 합니다.
- 문서에 명시된 제목, 문구, 조항, 숫자, 시점 등을 그대로 인용하거나 요약해야 합니다.
- SECTION 0에 없는 내용을 임의로 추정하거나 일반적인 계약서 형식으로 답변해서는 안 됩니다.

[SECTION 1 이후]
- 관련 법령, 판례, 규정 등 일반적인 법률 정보입니다.
- 이는 계약서 내용을 해석·평가하기 위한 보조 자료입니다.
...
[답변 생성 원칙]
1) 법적 위계 준수
- SECTION 0이 제공된 경우, 반드시 그 내용을 먼저 읽고 답변하세요.
